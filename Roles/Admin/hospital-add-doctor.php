...
<?php   
  ...
  if(isset($_POST["submit"]))
  {
      //post all value
      extract($_POST);
      $query = "INSERT INTO `doctors` (`doc_id`, `name`,`email`, `qualification`,`speciality`,`address`,`bio`,`username`,`password`) VALUES (NULL, '".$name."', '".$email."','".$qualification."','".$speciality."','".$address."','".$bio."','".$username."','".$password."');";

      mysqli_query($con,$query);
      header("Location: hospital-add-doctor.php");
