...
if (isset($_SESSION['SESSION_USERNAME'])) {
  ...
  if(isset($_POST["submit"]))
  {
      //post all value
      extract($_POST);
      $query = "INSERT INTO `lab_technisian` (`l_id`, `fullname`,`email`, `qualification`,`address`,`bio`,`l_username`,`l_password`) VALUES (NULL, '".$fullname."', '".$email."','".$qualification."','".$fulladdress."','".$bio."','".$username."','".$password."');";

      mysqli_query($con,$query);
      header("Location: hospital-add-lab.php");
		...
		************* -->
		...
		<div class="container-fluid">
						...
						<div class="col-lg-6 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Enter Technisian Details</div>
								</div>
								<div class="card-body">
									<div class="row gutters">
										<div class="col-sm-6 col-12">
											<div class="form-group">
												...
												<input type="text" name="fullname" class="form-control" id="fullName" placeholder="Srinu">
											</div>
										</div>
										<div class="col-sm-6 col-12">
											<div class="form-group">
										...
										<div class="col-sm-6 col-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="fulladdress" id="addreSs" rows="3" placeholder="Current Address"></textarea>
											</div>
										</div>
										<div class="col-sm-6 col-12">
											<div class="form-group">
			...
			************* -->
			...
			<footer class="main-footer">© 2024</footer>
